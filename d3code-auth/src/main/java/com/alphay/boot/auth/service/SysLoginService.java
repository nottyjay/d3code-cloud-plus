...
import com.alphay.boot.auth.properties.UserPasswordProperties;
import com.alphay.boot.common.core.constant.*;
...
import com.alphay.boot.common.tenant.exception.TenantException;
...
public class SysLoginService {
  ...
  public void register(RegisterBody registerBody) {
    ...
    recordLogininfor(
        tenantId, username, Constants.REGISTER, MessageUtils.message("user.register.success"));
  }
