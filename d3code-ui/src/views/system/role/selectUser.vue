<template>
  <el-row>
    <el-dialog v-model="visible" title="选择用户" width="800px" top="5vh" append-to-body>
      ...
      <el-row>
        <el-table ref="tableRef" border :data="userList" height="260px" @row-click="clickRow"
        ...
        <pagination v-if="total > 0" v-model:page="queryParams.pageNum" v-model:limit="queryParams.pageSize"
