<template>
  <el-form ref="genInfoForm" :model="infoForm" :rules="rules" label-width="150px">
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="tenantFlag">
          <template #label>租户管理</template>
          <el-select v-model="infoForm.tenantFlag">
        ...
        <el-col :span="12">
          <el-form-item>
            ...
            <el-select v-model="infoForm.treeParentCode" placeholder="请选择">
              <el-option v-for="(column, index) in infoForm.columns" :key="index"
                         :label="column.columnName + '：' + column.columnComment" :value="column.columnName"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item>
            ...
            <el-select v-model="infoForm.subTableName" placeholder="请选择" @change="subSelectChange">
              <el-option v-for="(t, index) in table" :key="index" :label="t.tableName + '：' + t.tableComment"
                         :value="t.tableName"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
