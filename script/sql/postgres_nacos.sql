...
COMMENT
ON COLUMN "config_info"."encrypted_data_key" IS '秘钥';
COMMENT
...
COMMENT
ON COLUMN "config_info_gray"."id" IS '自增ID';
COMMENT
ON COLUMN "config_info_gray"."data_id" IS 'data_id';
COMMENT
ON COLUMN "config_info_gray"."group_id" IS 'group_id';
COMMENT
ON COLUMN "config_info_gray"."content" IS 'content';
COMMENT
ON COLUMN "config_info_gray"."md5" IS 'md5';
COMMENT
ON COLUMN "config_info_gray"."src_user" IS 'src_user';
COMMENT
ON COLUMN "config_info_gray"."src_ip" IS 'src_ip';
COMMENT
ON COLUMN "config_info_gray"."gmt_create" IS 'gmt_create';
COMMENT
ON COLUMN "config_info_gray"."gmt_modified" IS 'gmt_modified';
COMMENT
ON COLUMN "config_info_gray"."app_name" IS 'app_name';
COMMENT
ON COLUMN "config_info_gray"."tenant_id" IS 'tenant_id';
COMMENT
ON COLUMN "config_info_gray"."gray_name" IS 'gray_name';
COMMENT
ON COLUMN "config_info_gray"."gray_rule" IS 'gray_rule';
COMMENT
ON COLUMN "config_info_gray"."encrypted_data_key" IS 'encrypted_data_key';
...
COMMENT
ON COLUMN "config_info_beta"."encrypted_data_key" IS '秘钥';
COMMENT
...
COMMENT
ON COLUMN "config_tags_relation"."nid" IS '自增长标识';
COMMENT
...
COMMENT
ON COLUMN "his_config_info"."nid" IS '自增标识';
COMMENT
ON COLUMN "his_config_info"."app_name" IS 'app_name';
COMMENT
ON COLUMN "his_config_info"."tenant_id" IS '租户字段';
COMMENT
ON COLUMN "his_config_info"."encrypted_data_key" IS '秘钥';
COMMENT
ON COLUMN "his_config_info"."publish_type" IS 'publish type gray or formal';
COMMENT
...
insert into config_info(data_id, group_id, content, md5, gmt_create, gmt_modified, src_user, src_ip, app_name,
                        tenant_id, c_desc, c_use, effect, type, c_schema, encrypted_data_key)
values ('application-common.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:18:55', '2022-01-09 15:18:55', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '通用配置基础配置', NULL, NULL, 'yaml', NULL, ''),
       ('datasource.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:19:07', '2022-01-09 15:19:07', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '数据源配置', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-gateway.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:19:43', '2022-01-09 15:22:42', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '网关模块', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-auth.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:19:43', '2022-01-09 15:22:29', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '认证中心', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-monitor.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:20:18', '2022-01-09 15:22:15', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '监控中心', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-system.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:20:18', '2022-01-09 15:22:03', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '系统模块', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-gen.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:20:18', '2022-01-09 15:21:51', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '代码生成', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-job.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:20:18', '2022-01-09 15:21:36', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '定时任务', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-resource.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:20:35', '2022-01-09 15:21:21', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '文件服务', NULL, NULL, 'yaml', NULL, ''),
       ('sentinel-d3code-gateway.json', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:21:02', '2022-01-09 15:21:02', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', '限流策略', NULL, NULL, 'json', NULL, ''),
       ('seata-server.properties', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:21:02', '2022-01-09 15:21:02', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', 'seata配置文件', NULL, NULL, 'properties', NULL, ''),
       ('d3code-sentinel-dashboard.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:21:02', '2022-01-09 15:21:02', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', 'sentinel控制台配置文件', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-snailjob-server.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:21:02', '2022-01-09 15:21:02', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_dev', 'SJ定时任务控制台', NULL, NULL, 'yaml', NULL, ''),

       ('application-common.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '通用配置基础配置', NULL, NULL, 'yaml', NULL, ''),
       ('datasource.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '数据源配置', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-gateway.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '网关模块', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-auth.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '认证中心', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-monitor.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '监控中心', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-system.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '系统模块', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-gen.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '代码生成', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-job.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '定时任务', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-resource.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '文件服务', NULL, NULL, 'yaml', NULL, ''),
       ('sentinel-d3code-gateway.json', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:23:00', '2022-01-09 15:23:00', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', '限流策略', NULL, NULL, 'json', NULL, ''),
       ('seata-server.properties', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:21:02', '2022-01-09 15:21:02', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', 'seata配置文件', NULL, NULL, 'properties', NULL, ''),
       ('d3code-sentinel-dashboard.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:21:02', '2022-01-09 15:21:02', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', 'sentinel控制台配置文件', NULL, NULL, 'yaml', NULL, ''),
       ('d3code-snailjob-server.yml', 'DEFAULT_GROUP', '# 将项目路径：config/下对应文件中内容复制到此处',
        '2944a25cb97926efcaa43b3ad7a64cf0', '2022-01-09 15:21:02', '2022-01-09 15:21:02', NULL, '0:0:0:0:0:0:0:1', '',
        'd3code-vue-plus_prod', 'SJ定时任务控制台', NULL, NULL, 'yaml', NULL, '');

insert into tenant_info(id, kp, tenant_id, tenant_name, tenant_desc, create_source, gmt_create, gmt_modified)
values (1, '1', 'd3code-vue-plus_dev', 'd3code-vue-plus_dev', '开发环境', NULL, 1641741261189, 1641741261189),
       (2, '1', 'd3code-vue-plus_prod', 'd3code-vue-plus_prod', '生产环境', NULL, 1641741270448, 1641741287236);
