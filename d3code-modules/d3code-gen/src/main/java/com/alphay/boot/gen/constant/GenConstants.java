package com.alphay.boot.gen.constant;
...
public interface GenConstants {
  ...
  String[] COLUMNTYPE_STR = {
    "char", "varchar", "enum", "set", "nchar", "nvarchar", "varchar2", "nvarchar2"
  };
  ...
  /** Entity基类字段 */
  String[] BASE_ENTITY = {
    "createDept", "createBy", "createTime", "updateBy", "updateTime", "tenantId"
  };
