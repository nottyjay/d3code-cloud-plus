package com.alphay.boot.gen.util;
...
public class VelocityUtils {
  ...
  public static VelocityContext prepareContext(GenTable genTable) {
    ...
    velocityContext.put("isTenant", genTable.getTenantFlag());
    velocityContext.put(
  ...
  public static HashSet<String> getImportList(GenTable genTable) {
    ...
    for (GenTableColumn column : columns) {
      if ((!column.isSuperColumn() || column.isQuery())
          && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
        ...
        importList.add("com.alphay.boot.common.translation.annotation.Translation");
        importList.add("com.alphay.boot.translation.constant.TransConstant");
      }
    }
    return importList;
  }
