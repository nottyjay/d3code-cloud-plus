...
public interface IGenTableService {
   ...
   * 查询业务列表
   *
   * @param queryParam 业务信息
   * @return 业务集合
   */
  PageResult<GenTable> queryPageList(GenTableQueryParam queryParam);
   ...
   * @return 数据库表集合
   */
  PageResult<GenTable> queryPageDbTableList(GenTableQueryParam queryParam);
