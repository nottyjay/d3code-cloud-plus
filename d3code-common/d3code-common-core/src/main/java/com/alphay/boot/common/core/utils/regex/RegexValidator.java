package com.alphay.boot.common.core.utils.regex;

import cn.hutool.core.exceptions.ValidateException;
import cn.hutool.core.lang.Validator;
import com.alphay.boot.common.core.factory.RegexPatternPoolFactory;
...
public class RegexValidator extends Validator {
   ...
   * @throws ValidateException 如果验证失败
   */
  public static <T extends CharSequence> T validateStatus(T value, String errorMsg)
      throws ValidateException {
    if (!isStatus(value)) {
      throw new ValidateException(errorMsg);
    }
