package com.alphay.boot.common.websocket.handler;

import static com.alphay.boot.common.websocket.constant.WebSocketConstants.LOGIN_USER_KEY;

import cn.hutool.core.util.ObjectUtil;
import com.alphay.boot.common.websocket.dto.WebSocketMessageDto;
...
public class PlusWebSocketHandler extends AbstractWebSocketHandler {
  ...
  public void afterConnectionEstablished(WebSocketSession session) throws IOException {
    ...
    log.info(
        "[connect] sessionId: {},userId:{},userType:{}",
        session.getId(),
        loginUser.getUserId(),
  ...
  public void handleTransportError(WebSocketSession session, Throwable exception) throws Exception {
    log.error(
        "[transport error] sessionId: {} , exception:{}", session.getId(), exception.getMessage());
  }
  ...
  public void afterConnectionClosed(WebSocketSession session, CloseStatus status) {
    ...
    log.info(
        "[disconnect] sessionId: {},userId:{},userType:{}",
        session.getId(),
        loginUser.getUserId(),
        loginUser.getUserType());
  }
