...
import com.alphay.boot.common.excel.annotation.ExcelEnumFormat;
 ...
 *
 * <p>即只有前1000行的数据可以用下拉框，超出的自行通过限制数据量的形式，第二次输出
 *
 * @author Nottyjay
 * @since 1.0.0
 */
...
public class ExcelDownHandler implements SheetWriteHandler {
   ...
   *
   * <p>例如第1列，index为0，解析出来为A列 第27列，index为26，解析为AA列
   *
   * <p>第28列，index为27，解析为AB列
   *
