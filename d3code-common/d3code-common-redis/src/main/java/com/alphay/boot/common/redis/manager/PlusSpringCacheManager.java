 ...
 */
package com.alphay.boot.common.redis.manager;
...
public class PlusSpringCacheManager implements CacheManager {
  ...
  /**
   * Defines if cache aware of Spring-managed transactions. If {@code true} put/evict operations are
   * executed only for successful transaction in after-commit phase.
   *
